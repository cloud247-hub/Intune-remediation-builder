...
- Når for eksempel **Sikkerhet** velges, vises bare oppskrifter i kategorien Sikkerhet, inkludert Defender- og ASR-oppskriftene.
...
- Microsoft-inspirert blått fargetema bygget rundt `#00A4EF`.
...
## Defender- og ASR-oppskrifter

Disse fire oppskriftene ligger i det ordinære oppskriftsrutenettet under kategorien **Sikkerhet**:
...
- Responsivt DomainGuard-inspirert design med Microsoft-blå aksentfarge `#00A4EF`
